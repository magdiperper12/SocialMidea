...
function Addposts() {
	return (
		<div className='w-auto  bg-white rounded-lg shadow-md mx-3 md:px-4 py-3 '>
			<div className='flex justify-start items-center gap-3 md:gap-5 md:px-3  overflow-scroll overflow-y-auto scroll-hidden'>
				...
				<div className='w-[75%] md:w-[90%] lg:w-[95%]'>
					...
					<div className='w-full gap-2 md:gap-4 text-xs md:text-md  py-3 text-gray-500 cursor-pointer  flex px-2 md:px-5 justify-start items-end'>
